...
static func get_all_skill_definitions() -> Dictionary:
	...
	skills["charge"] = {"display_name": "Charge", "description": "Rush forward and stun the first enemy hit.", "target_type": "POINT", "cooldown": 5.0, "mana_cost": 8.0, "damage": 20.0, "range_dist": 12.0, "icon_color": Color(0.95, 0.6, 0.1)}
	...
	skills["fire_wall"] = {"display_name": "Fire Wall", "description": "Create a wall of flame that damages enemies passing through.", "target_type": "POINT", "cooldown": 8.0, "mana_cost": 18.0, "damage": 15.0, "duration": 5.0, "range_dist": 10.0, "icon_color": Color(0.9, 0.3, 0.0)}
	...
	skills["arcane_missiles"] = {"display_name": "Arcane Missiles", "description": "Fire a rapid volley of arcane bolts.", "target_type": "POINT", "cooldown": 1.5, "mana_cost": 8.0, "damage": 18.0, "range_dist": 10.0, "icon_color": Color(0.6, 0.3, 1.0)}
